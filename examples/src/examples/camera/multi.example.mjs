// @config
//
// `WASDQE` 移动 · 按住 `Shift` 快速移动 · 按住 `Ctrl` 慢速移动 · `鼠标左键/右键` 环绕/飞行 · 按住 `Shift` 或 `鼠标中键` 平移 · `滚轮/双指` 缩放 · `F` 聚焦 · `R` 重置
...
const assets = {
    ...
    statue: new pc.Asset('statue', 'container', { url: './assets/scene/models/1988548899212464128_draco.glb' })
};
